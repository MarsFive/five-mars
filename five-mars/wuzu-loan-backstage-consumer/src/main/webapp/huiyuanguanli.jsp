...
--%>
    <div data-options="region:'west',title:'菜单栏',split:true" style="width:216px;">

        <div title="第一个手风琴" data-options="iconCls:'icon-save',selected:true" style="overflow:auto;padding:10px;">
            <div id="hy" class="easyui-tree">
            </div>
        </div>
    ...
    <div data-options="region:'center',title:'内容显示页'" style="background:#eee;">
        ...
        <div id="tabsaaa" class="easyui-tabs" data-options="fit:true">
...
<script type="text/javascript">
    ...
    $("#hy").tree({
        ...
        url:"<%=request.getContextPath()%>/tree/selectTreeList.do",  //根据权限查树
        method:"post",
        checkbox:true,
        ...
        onSelect: function(node){
            ...
            if(node.url != null && node.url != ""){
                ...
                var falg=$("#tabsaaa").tabs('exists',node.text);
                if(falg){

                    $("#tabsaaa").tabs('select',node.text);
                }else {
